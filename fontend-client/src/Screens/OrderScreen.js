...
import { orderDetailFail, orderDetailRequest, orderDetailSuccess } from "../redux/order/orderDetailSlice"
              ...
              <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
                <div className="row">
                  ...
                  <div className="col-md-8 center">
                    ...
                    <p>BookDate: {moment(order.createAt).calendar()}</p>
                  </div>
                </div>
              </div>
              {/* 3 */}
                    ...
                    {order.isConfirm ? (
                      <div className="bg-info p-2 col-12">
                        <p className="text-white text-center text-sm-start">
                          Confirm on {moment(order.confirmAt).calendar()}
                        </p>
                      </div>
                    ) : (
